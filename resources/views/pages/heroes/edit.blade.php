                        ...
                        <form method="post" action="{{ route('heroes.update', $hero) }}" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_en" id="title_en" class="form-control"
                                                value="{{ old('title_en', $hero->title_en) }}" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                for="button_text_en">{{ __('Button Text') }}</label>
                                            <input type="text" name="button_text_en" id="button_text_en"
                                                class="form-control"
                                                value="{{ old('button_text_en', $hero->button_text_en) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_ar" id="title_ar" class="form-control"
                                                value="{{ old('title_ar', $hero->title_ar) }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-control-label"
                                        ...
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                for="button_text_ar">{{ __('Button Text') }}</label>
                                            <input type="text" name="button_text_ar" id="button_text_ar"
                                                class="form-control"
                                                value="{{ old('button_text_ar', $hero->button_text_ar) }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group d-none">
                                        <label class="form-control-label"
                                            for="service_page_slug">{{ __('Service Page Slug') }}</label>
                                        <input type="text" name="service_page_slug" id="service_page_slug"
                                            class="form-control"
                                            value="{{ old('service_page_slug', $hero->service_page_slug) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label" for="cover_image">{{ __('Cover Image') }}
                                                (Max 5MB)</label>
                                            <input type="file" name="cover_image" id="cover_image" class="form-control">
                                            @if ($hero->cover_image)
                                                <div class="mt-3">
                                                    <label class="form-control-label">{{ __('Current Image') }}</label>
                                                    <img src="{{ asset($hero->cover_image) }}" class="img-fluid"
                                                        style="max-height: 200px;" alt="Current Hero Image">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
