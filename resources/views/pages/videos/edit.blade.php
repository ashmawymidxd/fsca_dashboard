...
@section('content')
    @include('users.partials.header', [
        'title' => __('Edit Video'),
        'description' => __('Update your video information.'),
        'class' => 'col-lg-12',
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Edit Video') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('videos.update', $video->id) }}" enctype="multipart/form-data" id="videoEditForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card bg-dark text-white mb-3">
                                        <div class="card-body p-0">
                                            <video controls class="w-100 rounded-top" style="max-height: 300px;">
                                            ...
                                            <div class="p-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <span class="font-weight-bold">{{ basename($video->path) }}</span>
                                                    </div>
                                                    <div>
                                                        <a href="{{ asset($video->path) }}"
                                                           download
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="video">
                                        {{ __('Replace Video') }} <small class="text-muted">(optional)</small>
                                    </label>
                                    ...
                                    <div class="dropzone mb-3" id="videoDropzone">
                                        <div class="dz-default dz-message">
                                            ...
                                            <h5 class="dropzone-msg-title">{{ __('Drag and drop new video here') }}</h5>
                                    ...
                                    <div id="videoPreviewContainer" class="text-center mt-3 d-none">
                                        <div class="card bg-dark text-white">
                                            <div class="card-body p-0">
                                                <video id="videoPreview" controls class="w-100 rounded-top" style="max-height: 300px;"></video>
                                                <div class="p-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                    ...
                                    <small class="form-text text-muted">
                                        {{ __('Leave blank to keep current video. Accepted formats: MP4, MOV, AVI, WMV. Max size: 50MB') }}
                                    </small>
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a href="{{ route('videos.show', $video->id) }}" class="btn btn-secondary btn-lg ml-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#videoEditForm').on('submit', function(e) {
                ...
                // Show progress bar only if a new file is being uploaded
