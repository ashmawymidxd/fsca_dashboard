...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Here you can manage your certificates'),
        'class' => 'col-lg-12',
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Certificate Overview') }}</h3>
                            </div>
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush mt-3 w-100" id="certificateTable">
                                ...
                                <tbody id="sortable">
                                    @foreach ($certificates as $certificate)
                                        <tr data-id="{{ $certificate->id }}">
                                            ...
                                            <td>
                                                <img src="{{ asset($certificate->cover_image) }}" alt="{{ $certificate->title_en }}"
                                                    class="img-thumbnail" style="max-width: 100px;">
                                            </td>
                                            <td>{{ $certificate->title_en }}</td>
                                            <td>{{ Str::limit($certificate->description_en, 50) }}</td>
        ...
        $(document).ready(function() {
            ...
            const sortable = new Sortable(document.getElementById('sortable'), {
                ...
                onEnd: function() {
                    ...
                    $.ajax({
                        url: "{{ route('certificates.reorder') }}",
                        type: 'POST',
                        data: {
                            certificates: order,
                            _token: "{{ csrf_token() }}"
