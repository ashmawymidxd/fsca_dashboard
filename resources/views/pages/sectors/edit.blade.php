            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body bg-white">
                        <form method="post" action="{{ route('sectors.update', $sector) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title_en') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title_en" id="input-title-en" class="form-control form-control-alternative{{ $errors->has('title_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Vehicle title in English') }}" value="{{ old('title_en', $sector->title_en) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('title_ar') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title_ar" id="input-title-ar" class="form-control form-control-alternative{{ $errors->has('title_ar') ? ' is-invalid' : '' }}" placeholder="{{ __('Vehicle title in Arabic') }}" value="{{ old('title_ar', $sector->title_ar) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('description_en') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description_en" id="input-description-en" class="form-control form-control-alternative{{ $errors->has('description_en') ? ' is-invalid' : '' }}" rows="3" placeholder="{{ __('Vehicle description in English') }}" required>{{ old('description_en', $sector->description_en) }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('description_ar') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description_ar" id="input-description-ar" class="form-control form-control-alternative{{ $errors->has('description_ar') ? ' is-invalid' : '' }}" rows="3" placeholder="{{ __('Vehicle description in Arabic') }}" required>{{ old('description_ar', $sector->description_ar) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset($sector->cover_image) }}" alt="{{ $sector->title }}" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                </div>
