            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body bg-white">
                        <form method="post" action="{{ route('trains.update', $train) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{ asset($train->cover_image) }}" alt="{{ $train->title }}" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                </div>
